...
class MenuItemApi {
  static const String baseUrl = 'https://food-delivery-backend-hazel.vercel.app/api/menu-items';
  ...
  static Future<ApiResponse<List<MenuItem>>> getOtherMenuItemsOfVendor(String menuItemId) async {
    try {
